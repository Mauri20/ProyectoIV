...
import com.claseoct.zeligstore.databinding.ItemNikeBinding
import com.claseoct.zeligstore.databinding.ItemVansBinding

class NikeHolder(view: View): RecyclerView.ViewHolder(view) {
    private val binding= ItemNikeBinding.bind(view)

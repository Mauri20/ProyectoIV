...
import com.claseoct.zeligstore.databinding.ItemConverseBinding
import com.claseoct.zeligstore.databinding.ItemRebookBinding

class ConverseHolder(view: View): RecyclerView.ViewHolder(view) {
    private val binding=ItemConverseBinding.bind(view)
    fun bind(zapato: ZapatosClass){
        ...
        binding.ivItemConverse.setImageBitmap(bitMap)

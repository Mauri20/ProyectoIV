...
import com.claseoct.zeligstore.databinding.ItemAdidasBinding

class AdidasHolder(view:View): RecyclerView.ViewHolder(view) {
    private val binding= ItemAdidasBinding.bind(view)
    fun bind(zapato: ZapatosClass){
        ...
        binding.ivItemAdidas.setImageBitmap(bitMap)

...
import com.claseoct.zeligstore.Adapters.PumaAdapter
...
class PumaActivity : AppCompatActivity() {
    ...
    private lateinit var adapterRecycler: PumaAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recycler=findViewById(R.id.cv_puma)
    ...
    private fun iniciarRecyclerView(){
        ...
        adapterRecycler= PumaAdapter(listaZapatos)
